...
inputSearch.addEventListener("keyup", (e) => {
  const errorAlert = document.querySelector("#errorLenght");
  let city = inputSearch.value.replace(/\s+/g, "");
  if (city.length >= 3 && e.key === "Enter") {
  ...
  } else if (city.length <= 2 && e.key === "Enter") {
    errorAlert.textContent = "ingrese al menos 3 caracteres";
